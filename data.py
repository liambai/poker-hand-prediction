...
c.execute('''CREATE TABLE Games(game_ID varchar(256) not null, stakes float, cards varchar(256), pre_flop_pot float, post_flop_pot float, post_turn_pot float, post_river_pot float)''')
